...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Statera-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.stateratools.com", "dnsseed.staterapool.org", "dnsseed.ltc.xurious.com", "dnsseed.koin-project.com", "seed-a.statera.loshan.co.uk", "dnsseed.thrasher.io", ""};
static const string testnet_seeds[] = {"testnet-seed.stateratools.com", "seed-b.statera.loshan.co.uk", "testnet-seed.ltc.xurious.com", "dnsseed-testnet.thrasher.io", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 61472), true);
  }
  do {
